...
// Captioned welcome video from Luke (2:51, ~74MB H.264). Generated by
// scripts/caption-booked-video.py — runs faster-whisper on the source
// and burns TikTok-style 3-word-chunk captions in via ffmpeg. To swap
// in a new recording, drop the source MP4 path into the script and run.
const VSL_SRC = "/booked-vsl.mp4";
...
export default function BookedPage() {
  return (
    ...
    >
      ...
      {/* ── WELCOME VIDEO ───────────────────────────────────────────────
          Captioned welcome from Luke. Same Hormozi-style click-to-unmute
          pattern used on /vip and /onboarding/qualified so the audio
          gates consistently. No CTA gate here (post-conversion). */}
