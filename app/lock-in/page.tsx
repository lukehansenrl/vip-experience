      ...
      <section className="border-t border-white/10 px-6 py-16 md:py-20">
        <div className="mx-auto max-w-2xl">
          ...
          <h2 className="mt-3 text-2xl font-extrabold tracking-tight md:text-3xl">
            A One-Time Prepay Window
          </h2>
          <p className="mt-5 leading-relaxed text-white/60">
            Because the price is changing Sunday, I wanted to give you the option to prepay at your current rate and save a couple months. No pressure — your monthly rate is locked either way.
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            If you&apos;d prefer to just keep paying monthly, that&apos;s completely fine. You don&apos;t need to do anything.
          </p>
          <p className="mt-4 leading-relaxed text-white/60">
            If you&apos;d like to lock in for longer and pocket some savings, here are the two options.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-8">
              ...
              <ul className="mt-6 space-y-3">
                ...
                <li className="flex items-start gap-2 text-sm text-white/70">
                  <Check className="mt-0.5 h-4 w-4 flex-shrink-0 text-[var(--green)]" />
                  No billing cycles, no surprises for 6 months
                </li>
              </ul>
              <a
      ...
      <section className="border-t border-white/10 px-6 py-20">
        <div className="mx-auto max-w-2xl text-center">
          <p className="leading-relaxed text-white/60">
            However you want to do this, you&apos;re set. No pressure, no tricks — just wanted to give you the option before the window closes.
          </p>
