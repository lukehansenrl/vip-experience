...
// started the free trial), so we don't show "buy Clubhouse" CTAs. Same
// VSL + Calendly UX as /onboarding/qualified, with a Clubhouse welcome
// section appended for first-week setup tasks.
//
// /onboarding/qualified stays as-is for non-RLC-member audiences (and
// for Luke's existing reference). Don't merge the two unless you also
// update the Clubhouse repo's redirect at /onboarding/welcome-book-vip-call.
...
// VSL (real playback time, pausing pauses the gate).
    ...
    >
      ...
      <section className="px-6 pb-14">
        <div className="mx-auto max-w-4xl">
          ...
          {/* Primary CTA. No secondary "buy Clubhouse" link because this
              audience is already inside. */}
      ...
      {/* SECTION 2: BOOKING WIDGET, hidden until VSL timer expires */}
      {unlocked ? (
        <section
          ref={schedulerRef}
        ...
        >
          <div className="mx-auto max-w-4xl">
            ...
            <h2 className="font-display mx-auto mt-3 max-w-3xl text-center text-3xl leading-tight tracking-tight md:text-4xl">
              Want to learn how to improve and rank up faster with our team
              of pros?
            </h2>
      ...
      {/* ── SECTION 3: CLUBHOUSE WELCOME + FIRST-WEEK TASKS ─────────────
          Always visible. These visitors already have access (or just
          started the free trial), so we point them at the server and
          give them their first-week orientation. */}
